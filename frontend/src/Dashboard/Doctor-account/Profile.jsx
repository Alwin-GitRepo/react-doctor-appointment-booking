...
const Profile = ({doctorData}) => {
  ...
  return (
  <div>
    <h2 className="text-[#181A1E] font-bold text-[24px] leading-9 mb-10">Profile Information</h2>
    <form>
        <div className="mb-5">
        ...
        <div className="mb-5">
            <div className="grid grid-cols-3 gap-5 mb-[30px]">
                ...
                <div>
                    ...
                    <input type="text" name="ticketPrice" value={formData.ticketPrice} onChange={handleInputChange} placeholder="1000" className="form__input" />
                </div>
            </div>
        </div>
        <div className="mb-5">
                ...
                <div key={index}>
                    <div>
                        <div className="grid grid-cols-2 gap-5 ">
                            <div>
                                <p className="m-2 form_label">Starting Date*</p>
                            ...
                            <div>
                                <p className="m-2 form_label">Ending Date*</p>
                    ...
                    <div>
                        <div className="grid grid-cols-2 gap-5 mt-5">
                            <div>
                                <p className="m-2 form_label">Degree*</p>
                                <input type="text" name="degree" value={item.degree} className="form__input" onChange={e=>handleQualificationChange(e,index)} />
                            </div>
                            <div>
                                <p className="m-2 form_label">University*</p>
                                <input type="text" name="university" value={item.university} className="form__input" onChange={e=>handleQualificationChange(e,index)} />
                            </div>
                        </div>
                    </div>
                    <button onClick={e=>deleteQualification(e,index)} className="p-2 text-white bg-red-600 rounded-full text-[18px] mt-2 mb-[30px] cursor-pointer"><AiOutlineDelete/></button>
                </div>
            ))}
            <button onClick={addQualification} className="bg-[#000] px-5 rounded text-white h-fit cursor-pointer mb-[30px]">Add Qualification</button>
        </div>
        <div className="mb-5">
            ...
            {formData.experiences?.map((item,index)=>(
                <div key={index}>
                    ...
                    <div>
                        <div className="grid grid-cols-2 gap-5 mt-5">
                            <div>
                                <p className="m-2 form_label">Position*</p>
                                <input type="text" name="position" value={item.position} className="form__input" onChange={e=>handleExperienceChange(e,index)} />
                            </div>
                            <div>
                                <p className="m-2 form_label">Hospital*</p>
                                <input type="text" name="hospital" value={item.hospital} className="form__input" onChange={e=>handleExperienceChange(e,index)} />
                            </div>
                        </div>
                    </div>
                    <button onClick={e=>deleteExperience(e,index)} className="p-2 text-white bg-red-600 rounded-full text-[18px] mt-2 mb-[30px] cursor-pointer"><AiOutlineDelete/></button>
                </div>
            ))}
            <button onClick={addExperience} className="bg-[#000] px-5 rounded text-white h-fit cursor-pointer mb-[30px]">Add Experience</button>
        </div>
        <div className="mb-5">
                ...
                <div key={index}>
                    <div>
                        <div className="grid grid-cols-2 gap-5 md:grid-cols-4 mb-[30px]">
                            <div>
                                <p className="m-2 form_label">Day*</p>
                            ...
                            <div className="flex items-center">
                                <button onClick={e=>deleteTimeSlot(e,index)} className="p-2 text-white bg-red-600 rounded-full text-[18px] cursor-pointer mt-9"><AiOutlineDelete/></button>
                            </div>
                        </div>
                    </div>
                </div>
            ))}
            <button onClick={addTimeSlot} className="bg-[#000] px-5 rounded text-white h-fit cursor-pointer mb-[30px]">Add TimeSlot</button>
        </div>
        <div className="mb-5">
        ...
        <div className="flex items-center gap-3 mb-5">
            { formData.photo && <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-blue-600 flex items-center justify-center'>
                  <img src={formData.photo} alt="" className='w-[60px] h-[60px] rounded-full' />
                </figure>}
