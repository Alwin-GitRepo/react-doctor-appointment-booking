...
const Signup = () => {
  ...
  return <section className='px-5 m-5 xl:px-0'>
    <div className='max-w-[1170px] mx-auto'>
      <div className='grid grid-cols-1 lg:grid-cols-2'>
        {/* ================== Img box ================== */}
        <div className='hidden bg-blue-500 rounded-l-lg lg:block'>
          ...
          <div className="py-10 rounded-l-lg lg:pl-16">
            ...
            <div className='mb-5'>
              ...
              <div className="flex items-center gap-3 mb-5">
                { selectedFile && <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-blue-600 flex items-center justify-center'>
                  <img src={previewURL} alt="" className='w-[60px] h-[60px] rounded-full' />
                </figure>}
              ...
              <div className='mt-7'>
                <button disabled={loading && true} type='submit' className='w-full bg-blue-500 text-white leading-[30px] rounded-lg px-4 py-3'>
              ...
              <p className='mt-5 text-center text-textColor'>
                ...
                <Link className="ml-1 font-medium text-blue-600" to='/login'>Login</Link>
              </p>
